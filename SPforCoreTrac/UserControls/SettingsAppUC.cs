...
{
    public partial class SettingsAppUC : UserControl
    {
        public SettingsAppUC()
        {
            InitializeComponent();
        }
        ...
        private void SettingsAppUC_Load(object sender, EventArgs e)
        {
            this.btnSave.Enabled = false;
            if (CommonUtilities.ConfigFileExists())
            {
        ...
        private void UIControls()
        {
            ...
            this.txtBoxPassword.Text = DOAppDatabaseInfo.Password;
